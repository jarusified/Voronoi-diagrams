...
Voronoi2.prototype.randomPoints = function(){
    let ret = [];
    ret.push(new GP(31, 31, 0))
    ret.push(new GP(73, 30, 0))
    ret.push(new GP(182, 153, 0))
...
Voronoi2.prototype.addSite = function(polygon, newSite){
    ...
    if (cutEdges[0].site2 == null || cutEdge[1].site2 == null) {
    ...
    while (nextPolygon!=null) {
        ...
        cnt++;
        if (cnt == 10){
	    console.log("BUGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGG");
            break;
        }
